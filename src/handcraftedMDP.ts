...
HAND_MDP.addNode(new CustomNode("idk-0", -1.5, 0, false, [], ["XX----------XXX", "XX----------XXX", "XX---XX-----XXX", "XX-#-XXXX---XXX", "XX-----XX---&--", "XXXX---XX------", "XXXX---XX-----#", "XXXX--#XX---XXX", "XXXX---XX---XXX", "-------XX---XXX", "&------XX---XXX"],7));
...
HAND_MDP.addNode(new CustomNode("end-0", -0.0, 0, true, [], ["----------", "*---------", "*---------", "*---------", "*---------", "*---------", "*---------", "*---------", "*---------", "*---------", "**********"],8));
HAND_MDP.addNode(new CustomNode("end-1", -0.0, 0, true, [], ["-------------", "*------------", "*------------", "*------------", "*------------", "*------------", "*------------", "*------------", "*------------", "*------------", "*************"],8));
...
HAND_MDP.addNode(new CustomNode("ld-s-0", -2.3, 0, false, [], ["-XXXXXXXXXXXXX-", "-XXXXXXXXXXXXX-", "---------------", "---------------", "-------*-------", "-------#-------", "---------------", "---------------", "---------------", "_XXXXXXXXXXXXX-", "_XXXXXXXXXXXXX-"],6));
...
HAND_MDP.addDefaultEdge("ld-f-0", "idk-0", [["idk-0", 0.99], [KEY_DEATH, 0.01]]);
HAND_MDP.addDefaultEdge("ld-f-1", "idk-0", [["idk-0", 0.99], [KEY_DEATH, 0.01]]);
HAND_MDP.addDefaultEdge("ld-f-2", "idk-0", [["idk-0", 0.99], [KEY_DEATH, 0.01]]);

HAND_MDP.addDefaultEdge("ld-s-0", "idk-0", [["idk-0", 0.99], [KEY_DEATH, 0.01]]);
HAND_MDP.addDefaultEdge("ld-s-1", "idk-0", [["idk-0", 0.99], [KEY_DEATH, 0.01]]);
HAND_MDP.addDefaultEdge("ld-s-2", "idk-0", [["idk-0", 0.99], [KEY_DEATH, 0.01]]);
